...
import { n as Subscribable, s as shallowEqualObjects, p as hashKey, q as getDefaultState, t as notifyManager, w as useQueryClient, r as reactExports, x as noop, y as shouldThrowError, c as createLucideIcon, j as jsxRuntimeExports, b as cn, o, v as vt, z as useParams, d as useCart, e as useWishlist, k as useAuth, h as Skeleton, L as Link, f as Button, B as Badge, H as Heart, S as ShoppingCart, U as User } from "./index-B0MCdo7A.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, P as PresenceContext, b as usePresence, c as useIsomorphicLayoutEffect, d as LayoutGroupContext, m as motion, a as Lock, L as Label } from "./proxy-DFJVkvX7.js";
import { S as Separator, P as Package } from "./separator-BLzyZrXi.js";
import { S as StarRating, a as Star } from "./StarRating-DCZRtOlR.js";
import { b as useQuery, c as useProduct, a as useProducts } from "./useProducts-CcUgJX-N.js";
...
const MOCK_REVIEWS = [
  {
    ...
    userName: "Sarah M.",
    rating: 5,
    comment: "My golden retriever absolutely loves this food! His coat has never been shinier and he finishes every bowl. Highly recommend for picky eaters.",
  ...
  },
  {
    ...
    userName: "James T.",
    rating: 4,
    comment: "Great quality ingredients. A bit pricey but you get what you pay for. My vet approved it too.",
    createdAt: Date.now() - 864e5 * 12
  },
  {
    id: "r3",
    productId: "p2",
    ...
    userName: "Emily R.",
    rating: 5,
    comment: "Survived 3 weeks with our aggressive chewer — that's a record! Very impressed.",
  ...
  },
  {
    ...
    userName: "Lucas K.",
    rating: 5,
    comment: "Our Persian cat went crazy for this food on day one. We tried 4 brands before and this is the only one she eats without complaints.",
...
function RelatedProductCard({ product }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-square bg-muted/30 overflow-hidden", children: [
          ...
          discount && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-2 left-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary text-primary-foreground text-xs px-2 py-0.5", children: [
            "-",
            discount,
            "%"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              className: `absolute top-2 right-2 w-7 h-7 rounded-full border flex items-center justify-center transition-smooth ${inWishlist ? "border-accent bg-accent text-accent-foreground" : "border-border bg-card/80 text-muted-foreground hover:border-accent hover:text-accent"}`,
              "aria-label": inWishlist ? "Remove from wishlist" : "Add to wishlist",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Heart, { className: `w-3 h-3 ${inWishlist ? "fill-current" : ""}` })
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 flex flex-col gap-1.5 flex-1", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground line-clamp-2 leading-tight", children: product.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            StarRating,
            {
...
function ProductDetailPage() {
  ...
  const relatedProducts = relatedRaw ? relatedRaw.filter((p) => p.id !== id).slice(0, 4) : [];
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full md:w-[420px] aspect-square rounded-2xl shrink-0" }),
  ...
  if (!product) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-2xl mx-auto px-4 sm:px-6 py-20 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-6xl mb-4", children: "🔍" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl text-foreground mb-3", children: "Product not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground mb-6", children: "This product may no longer be available." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { className: "gap-2", children: [
  ...
  const inWishlist = isInWishlist(product.id);
  const discount = product.originalPrice ? Math.round((1 - product.price / product.originalPrice) * 100) : null;
  const userId = (principal == null ? void 0 : principal.toText()) ?? "guest";
  const alreadyReviewed = reviews ? reviews.some((r) => r.userId === userId && userId !== "guest") : false;
  ...
  const handleSubmitReview = async (e) => {
    ...
    if (alreadyReviewed) {
      ue.error("You have already reviewed this product.");
      return;
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-background min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-b border-border bg-card/60", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 py-3 flex items-center gap-2 text-sm text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: "/",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "capitalize", children: CATEGORY_LABELS[product.category] ?? product.category }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 py-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full md:w-[420px] shrink-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-square rounded-2xl overflow-hidden bg-muted/30 border border-border shadow-subtle", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: product.imageUrl,
                  alt: product.name,
              ...
              discount && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-4 left-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "bg-primary text-primary-foreground font-bold text-sm px-3 py-1 shadow-md", children: [
                "-",
                discount,
                "% OFF"
              ] }) }),
              !product.inStock && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 rounded-2xl bg-background/60 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg text-foreground bg-card border border-border px-5 py-2.5 rounded-xl", children: "Out of Stock" }) })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-2xl sm:text-3xl text-foreground leading-tight", children: product.name }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground mt-1 font-medium", children: [
                    "by ",
                    product.brand
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "button",
                  {
                    ...
                    className: `w-11 h-11 rounded-full border-2 flex items-center justify-center transition-smooth shrink-0 ${inWishlist ? "border-accent bg-accent text-accent-foreground shadow-md" : "border-border text-muted-foreground hover:border-accent hover:text-accent hover:bg-accent/10"}`,
                    "aria-label": inWishlist ? "Remove from wishlist" : "Add to wishlist",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-baseline gap-3 mt-4 pb-4 border-b border-border", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-3xl sm:text-4xl text-foreground", children: [
                  "$",
                  product.price.toFixed(2)
                ] }),
                ...
                discount && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-primary font-semibold bg-primary/10 px-2 py-0.5 rounded-full", children: [
                  "Save ",
                  discount,
                  "%"
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-4 leading-relaxed", children: product.description }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-4 mt-4 text-xs text-muted-foreground", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Tag, { className: "w-3.5 h-3.5 text-primary/70" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: product.tags.slice(0, 3).join(" · ") })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Separator,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    className: `flex items-center gap-1.5 font-semibold ${product.inStock ? "text-green-600" : "text-destructive"}`,
                    children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center border-2 border-border rounded-xl overflow-hidden", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "button",
                    {
                      type: "button",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  Button,
                  {
                    ...
                    children: [
                      ...
                      inCart ? `In Cart (${getQuantity(product.id)})` : "Add to Cart"
                    ]
                  }
                )
              ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-muted/20 rounded-2xl border border-border p-6 sm:p-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display font-bold text-xl text-foreground", children: [
            "Customer Reviews",
            reviews && reviews.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-muted-foreground font-normal text-base ml-2", children: [
              "(",
              reviews.length,
              ")"
            ] })
          ...
          !alreadyReviewed && /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              onClick: () => {
                if (!isLoggedIn) {
                  ue.info("Sign in to write a review", {
        ...
        alreadyReviewed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 text-sm text-green-700 bg-green-50 border border-green-200 rounded-lg px-4 py-2.5 mb-5 w-fit", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 shrink-0" }),
          "You have already reviewed this product."
        ] }),
        !isLoggedIn && !alreadyReviewed && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-xl p-4 mb-5 flex items-center gap-3 text-sm text-muted-foreground", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-4 h-4 shrink-0 text-primary" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: showReviewForm && isLoggedIn && !alreadyReviewed && /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-foreground", children: "Share Your Experience" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmitReview, className: "space-y-4", children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-sm font-medium", children: "Your Review" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Textarea,
                        {
        ...
        !reviews || reviews.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Star, { className: "w-12 h-12 mx-auto mb-3 opacity-20" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: "No reviews yet" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1", children: "Be the first to share your experience!" })
            ]
          }
        ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: reviews.map((review, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 mb-2.5", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-sm text-foreground leading-tight", children: review.userName }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: new Date(review.createdAt).toLocaleDateString(
                      "en-US",
                      {
                        month: "long",
                        day: "numeric",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-foreground/80 leading-relaxed pl-10", children: review.comment })
            ]
          },
          review.id
        )) })
        ...
        motion.div,
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-xl text-foreground", children: "Related Products" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  to: "/",
